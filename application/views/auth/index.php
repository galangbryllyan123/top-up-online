              ...
              <table class="table table-striped" id="table-1">
                ...
                <tbody>
                  ...
                  <?php foreach ($users as $user):?>
                   ...
                   <td>
                   <?php echo anchor("dashboard/auth/edit_user/".$user->id, 'Edit', "class='btn btn-info'") ;?>
                   </td>
               </tr>
             <?php endforeach;?>
           </tbody>
...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <?php echo anchor('dashboard/auth/create_user', lang('index_create_user_link'))?> - <?php echo anchor('dashboard/auth/create_group', lang('index_create_group_link'))?> - <a href="<?php echo base_url('dashboard/auth/mv') ?>">Refresh</a>
      </div>
    </div>
  </div>
</div>
