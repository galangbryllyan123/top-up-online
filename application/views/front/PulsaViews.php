          ...
          <div class="row align-items-stretch">
            <div class="col-md-4" data-aos="fade-up">
              <div class="text-center">
                <img src="<?php echo base_url(); ?>assets/upload/home/pulsa.png" class="img-fluid rounded-4" alt="Topup Pulsa Termurah" title="Topup Pulsa Termurah">
              </div>
              <br>
              <div class="bg-white rounded-4 p-3 mb-4">
                <div class="mt-3 text-dark">
                  ...
                  <h2 style="display:none">Web Panel Topup Pulsa Termurah</h2>
                  <h3 style="display:none">Panel PPOB Pulsa Termurah</h3>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
                ...
                for (var i = 0; i < data.length; i++) {
                  ...
                  if (data[i].brand === ops['operator'] && data[i].category == 'Pulsa') {
                    $(".listpulsa").append('<div class="col-md-4 col-6">'
                      +'<a price="'+data[i].newprice+'" style="width:100%;margin-top:2px;" id="'+data[i].buyer_sku_code+'"  class="readmore text-center text-white item rounded-3">'+data[i].product_name+'</a>'
                      +'</div>');
                  }
                }
              }
      ...
      if ($(window).width() < 960) {
        ...
        $(".deskpro").text('Ikuti catatan pada poin 1 saat memasukkan tujuan, pastikan tujuannya tepat dan valid untuk Pulsa All Operator, jika ada pertanyaan terkait topup dan pembelian hubungi kami segera. Masukan tujuan pesanan untuk Pulsa All Operator, pilih nominal pembelian, lakukan pembayaran, dan pesanan diproses otomatis. Untuk harga lebih murah gunakan saldo Akun. Kamu juga dapat menggunakan e-wallet, bank transfer, dan convenience store. <?php echo SITE_NAME; ?> adalah platform termurah untuk topup & pembelian item Pulsa All Operator dengan proses instan.');
      }
