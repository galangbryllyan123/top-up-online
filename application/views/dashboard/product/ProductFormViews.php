      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-4">
              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Deskripsi / Panduan Pembelian</label>
              <div class="col-sm-12 col-md-7">
            ...
            <div class="form-group row mb-4">
              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Thumbnail 500x500px <?php if ($page == 'edit'): ?>
              ...
              <div class="col-sm-12 col-md-7">
                ...
                <?php endif; ?> >
                <label for="image-upload" id="image-label">Pilih Logo</label>
